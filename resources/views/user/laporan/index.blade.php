...
@section('sidebar')
    ...
    <a href="/user/laporan" class="active">Laporan Saya</a>
@endsection

@section('content')
<div class="page-title">Laporan dan Pengaduan Saya</div>

<a href="/user/laporan/create" class="btn btn-green" style="margin-bottom:15px;">Kirim Laporan Baru</a>
